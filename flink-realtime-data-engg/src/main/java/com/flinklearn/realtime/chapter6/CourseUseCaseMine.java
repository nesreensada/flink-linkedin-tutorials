...
public class CourseUseCaseMine {
    public static void main(String[] args) {
        ...
        try{
            ...
            TextInputFormat browserFormat = new TextInputFormat(
                    new Path(dataDir));

            //Create a Datastream based on the directory
            DataStream<String> browserEventsStr
                    = streamEnv.readFile(browserFormat,
            ...
            DataStream<Tuple3<String, String, Long>> browserEventsObj
                    ...
                    .map(new MapFunction<String,Tuple3<String, String, Long>>() {
                        @Override
                        public Tuple3<String, String, Long> map(String browserStr) {
                            System.out.println("--- Received Record : " + browserStr);
                            String[] columns = browserStr
                                    .replace("\"","")
                                    .split(",");
